# Figure 2: adjusted 10-year risk heatmap by BP x UACR.
...
joint$n_label <- sprintf("n=%s; %s deaths",
                         format(joint$N, big.mark = ",", trim = TRUE),
                         format(joint$deaths, big.mark = ",", trim = TRUE))
...
save_figure(figure2, "Figure_2_Heatmap_BPxUACR_10yr_Risk", 10.8, 6.8)
