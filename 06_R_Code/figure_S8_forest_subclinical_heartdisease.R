# Supplementary Figure S8: subclinical subgroup forest (heart disease).
...
subclinical_heart <- build_forest_data(
  "death_hd", "Low-grade albuminuria (10-29 mg/g)"
)
save_plot(
  plot_forest_table(
    subclinical_heart,
    "Low-grade albuminuria and heart-disease mortality across subgroups",
    "Adjusted HRs compare UACR 10-29 mg/g with UACR <10 mg/g. Secondary/exploratory outcome; fewer events yield wider CIs.",
    "Subclin.", "#C0392B"
  ),
  "Supplementary_Figure_S8_Forest_Subclinical_HeartDisease"
)
